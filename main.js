(function (window) {
    ...
    window.onload = function () {
        ...
        function splat(x, y, dx, dy, color) {
            ...
            gl.uniform1f(splatProgram.uniforms.aspectRatio, screen.width / screen.height);
        ...
        do {
            var posX = scaleByPixelRatio(0);
            var posY = scaleByPixelRatio(0);
        ...
        document.addEventListener('mousemove', function (e) {
            ...
            var posX = scaleByPixelRatio(e.x);
            var posY = scaleByPixelRatio(e.y);
